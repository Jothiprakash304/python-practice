...
def Register(First,Last,DOB,Email,Password,Confirm_password):
    user_data_validation=Valid(First,Last,DOB,Email,Password,Confirm_password)
...
def Valid(First,Last,DOB,Email,Password,Confirm_password):
...
a=Register("jothi1","jothi0",date(1999,9,9),"jothi@gmail.com","jothiprakash","jothiprakash")
print(a)